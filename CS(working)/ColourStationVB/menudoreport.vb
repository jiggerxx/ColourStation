...
Public Class menudoreport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ColourStationVB.menudoreport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedmenudoreport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As menudoreport = New menudoreport()
        rpt.Site = Me.Site
        Return rpt
    End Function
