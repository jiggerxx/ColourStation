...
Public Class salesreportyearly
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ColourStationVB.salesreportyearly.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedsalesreportyearly
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As salesreportyearly = New salesreportyearly()
        rpt.Site = Me.Site
        Return rpt
    End Function
