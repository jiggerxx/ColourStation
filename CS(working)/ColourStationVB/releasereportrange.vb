...
Public Class releasereportrange
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ColourStationVB.releasereportrange.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedreleasereportrange
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As releasereportrange = New releasereportrange()
        rpt.Site = Me.Site
        Return rpt
    End Function
