...
Public Class acquiredreport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ColourStationVB.acquiredreport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedacquiredreport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As acquiredreport = New acquiredreport()
        rpt.Site = Me.Site
        Return rpt
    End Function
