...
Public Class pintorreporting
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ColourStationVB.pintorreporting.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedpintorreporting
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As pintorreporting = New pintorreporting()
        rpt.Site = Me.Site
        Return rpt
    End Function
