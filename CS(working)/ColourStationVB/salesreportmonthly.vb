...
Public Class salesreportmonthly
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ColourStationVB.salesreportmonthly.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedsalesreportmonthly
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As salesreportmonthly = New salesreportmonthly()
        rpt.Site = Me.Site
        Return rpt
    End Function
